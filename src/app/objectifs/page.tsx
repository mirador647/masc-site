...
export const metadata = { title: "Objectifs" } as any;
...
setGoals((g) => [{ id: crypto.randomUUID(), text: input.trim(), done: false }, ...g]);
setInput("");
}
...
<button onClick={() => remove(g.id)} className="opacity-60 hover:opacity-100">Supprimer</button>
</li>
))}
</ul>
</main>
